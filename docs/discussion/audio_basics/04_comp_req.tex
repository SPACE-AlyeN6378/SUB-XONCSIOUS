...
To design a real-time friendly audio engine with DSP, it must maintain real-time constraints, which includes
...
\begin{itemize}
    ...
    \item I/O operations (e.g. \texttt{printf()}, \texttt{std::cin}, etc.)
