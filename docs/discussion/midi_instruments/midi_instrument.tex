...
\input{discussion/midi_instruments/figures/instrument_arch.tex}
...
\begin{quote}
\textbf{NOTE}: MIDI Channel Segregates separate devices to allow a MIDI controller or sequencer to send different messages to each
of the devices.
\end{quote}
